...
const char* bulgeError_string(BulgeError error) {
#ifndef BULGE_ERROR_STRINGS
  return "(compiled without error strings)";
#endif // ifndef BULGE_ERROR_STRINGS
  ...
  switch(error) {
    ...
    case BULGE_ERROR_PATH_NOT_A_DIRECTORY   : return "given path is not a directory";
    case BULGE_ERROR_PATH_NOT_A_FILE        : return "given path is not a file";
    case BULGE_ERROR_PATH_EXISTS            : return "given path already exists";
    ...
    case BULGE_ERROR_ENTRY_TYPE_MISMATCH    : return "entry type mismatch";
    case BULGE_ERROR_ATTRIBUTES_NOT_CREATED : return "attributes for this entry not yet created";
